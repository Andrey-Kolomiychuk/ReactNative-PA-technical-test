...
//Если поменять booked: true на booked: false посты не будут отображаться в избранных. 
export const newData = data.map(function(ele){
         
  return {...ele, booked: true, diselike: false};
})